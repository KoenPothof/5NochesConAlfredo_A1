...
RectangleComponent::RectangleComponent(int x, int y, int z, int direction, bool flat, int width, int height, glm::vec2* texturePositions, float wallWidth)
{
    if (direction == 0 && flat == false) {
        ...
        verts.push_back(Vertex::PT(glm::vec3(x, y, z + wallWidth), texturePositions[0])); // bottom point
        verts.push_back(Vertex::PT(glm::vec3(x + width, y, z + wallWidth), texturePositions[1])); // far bottom point
        verts.push_back(Vertex::PT(glm::vec3(x + width, y + height, z + wallWidth), texturePositions[2])); // far top point
